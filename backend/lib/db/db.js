...
function connect({ source }){
    ...
    } else if(source === "test" || source === "dev" ){
        mongoose.connect(process.env.TESTDB, { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false }).then(() => console.log('Connected to test db')).catch((e) => console.log(`Not connected : ${e}`));
    }
}
